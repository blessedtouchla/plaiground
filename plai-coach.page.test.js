...
function runStatic() {
  ...
  assert.ok(index.includes('site.css?v=20260924w1'), 'homepage cache-busts site.css at 20260924w1');
  assert.ok(index.includes('site.js?v=20260924w1'), 'homepage cache-busts site.js at 20260924w1');
