...
function runStatic() {
  ...
  assert.ok(index.includes('site.css?v=20260918n2'), 'homepage cache-busts site.css at 20260918n2');
  assert.ok(index.includes('site.js?v=20260918n2'), 'homepage cache-busts site.js at 20260918n2');
  ...
  assert.ok(!index.includes('site.js?v=20260912w1'), 'w1 site.js stamp is retired on homepage');
