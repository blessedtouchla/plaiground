...
async function run() {
  ...
  assert.ok(/href="https:\/\/app\.tonegrid\.pro\/super\/login" target="_blank" rel="noopener noreferrer">ToneGrid dashboard<\/a>/.test(adminHtml.match(/<nav class="side-nav"[\s\S]*?<\/nav>/)[0]), 'owner desk links the store partner dashboard');
