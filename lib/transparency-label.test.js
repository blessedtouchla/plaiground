...
function run() {
  ...
  assert.ok(/Free account\. <span class="accent">\$2\.49<\/span> a song\./.test(hero[0]), 'homepage headline is the free account and $2.49 line');
  assert.ok(/After upload is why you stay\./.test(hero[0]), 'homepage sub says after upload is why you stay');
