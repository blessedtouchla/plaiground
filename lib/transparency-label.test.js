...
function run() {
  ...
  assert.ok(hero[0].includes(humanLane), 'homepage carries the Human-lane lock');
  assert.ok(hero[0].indexOf(lockedQuote) < hero[0].indexOf(humanLane), 'Human lane sits with the compliance quote');
