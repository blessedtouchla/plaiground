  ...
  function goOverview(event) {
    ...
    try {
      if (root.sessionStorage) {
        root.sessionStorage.removeItem('plaiground.store.draft');
        root.sessionStorage.removeItem('plaiground.tonegrid.draft');
        root.sessionStorage.removeItem('plaiground.store.held_draft');
      }
    } catch (errSess) {}
    try {
