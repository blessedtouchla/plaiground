...
function run() {
  ...
  assert.ok(html.includes('site.css?v=' + STAMP), 'Artist Profiles cache-busts site.css at ' + STAMP);
  ...
  assert.ok(html.includes('artists.js?v=' + STAMP), 'Artist Profiles cache-busts artists.js');
  ...
  assert.ok(listFn.includes('upload.html?artist='), 'card release uses the existing upload artist pick');
