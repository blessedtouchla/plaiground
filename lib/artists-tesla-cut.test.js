...
function run() {
  ...
  assert.ok(/Human<\/strong>\s*·\s*<strong>AI-assisted<\/strong>\s*·\s*<strong>Fully AI/.test(html), 'disclosure classes named');
  ...
  assert.ok(html.includes('class="artists-act-edu is-edit"'), 'edit flow keeps a lighter why-profile panel');
