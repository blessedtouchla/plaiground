 ...
 *
 * Picker ACCEPT is extension-only. Any audio/* or audio/mpeg MIME in
 * accept makes iOS show Photo Library + Take Video. .mpeg/.mpg are
 * video extensions on iOS. Validation below still allows those
 * MIME/ext variants after the file is chosen.
 */
...
(function loadUploadAudioBind(root) {
  ...
  try {
    ...
    script.src = 'lib/upload-audio-bind.js?v=20260913a1';
