...
function run() {
  ...
  assert.strictEqual(status.label('failed'), 'Needs fix');
  assert.strictEqual(status.label('qc_failed'), 'Needs fix');
  assert.strictEqual(status.label('qc_inspection'), 'Processing');
  assert.strictEqual(status.label('accepted'), 'Processing');
  assert.strictEqual(status.group('qc_inspection'), 'processing');
  assert.strictEqual(status.group('failed'), 'rejected');
  assert.strictEqual(status.isLive('qc_inspection'), false);
  assert.strictEqual(status.isLive('rejected'), false);
  assert.strictEqual(status.isLive('needs-fix'), false);
