...
function run() {
  ...
  assert.strictEqual(status.label('qc_inspection'), 'Needs fix');
  assert.strictEqual(status.isProblem('qc_inspection'), true);
  ...
  assert.strictEqual(status.problemAlert({ status: 'qc_inspection' }), qcLines);
  assert.strictEqual(status.problemAlert({ status: 'qc_rejected' }), qcLines);
  assert.strictEqual(status.problemAlert({ status: 'rejected' }), qcLines);
  ...
  assert.strictEqual(status.problemAlert({ status: 'processing' }), qcLines);
