...
function run() {
  ...
  assert.strictEqual(tonegridApi.protectHardDelete('1f26369b-e107-4c79-bde1-4c5382f9d511', 'Lightning', 'rejected'), false);
  assert.strictEqual(tonegridApi.protectHardDelete('7544eade-ce02-472c-92d0-a5d61609999d', 'Too the moon', 'qc_rejected'), false);
  assert.strictEqual(tonegridApi.protectHardDelete('df51342b-ba22-4093-93ff-35b6402b61c0', 'Thank You, Dolly', 'rejected'), false);
