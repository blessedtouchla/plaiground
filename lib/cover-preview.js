...
(function (root, factory) {
  ...
  function paintTile(tile, url) {
    ...
    if (art && typeof document !== 'undefined' && document.querySelector) {
      var note = document.querySelector('[data-song-cover-note], [data-review-cover-note]');
  ...
  function readDraft(win) {
    ...
    return Object.assign(
      {},
      parse(win.localStorage && win.localStorage.getItem('plaiground.tonegrid.draft')),
      parse(win.sessionStorage && win.sessionStorage.getItem('plaiground.tonegrid.draft')),
      parse(win.localStorage && win.localStorage.getItem('plaiground.store.draft')),
      parse(win.sessionStorage && win.sessionStorage.getItem('plaiground.store.draft'))
    );
  }

  function paintReviewCover() {
    if (typeof document === 'undefined' || !document.querySelector) return;
    var tile = document.querySelector('[data-review-cover], [data-song-cover]');
    if (!tile) return;
  ...
  if (typeof document !== 'undefined') {
    ...
    setTimeout(paintReviewCover, 2400);
  }
...
(function loadLeftoverArtHop(root) {
  if (!root || !root.document) return;
  try {
    if (root.document.querySelector('script[src*="leftover-art-hop.js"]')) return;
    var script = root.document.createElement('script');
    script.src = 'lib/leftover-art-hop.js?v=20260903cov1';
    (root.document.head || root.document.documentElement).appendChild(script);
  } catch (err) {}
})(typeof window !== 'undefined' ? window : this);

(function loadCoverBind(root) {
  if (!root || !root.document) return;
  try {
    if (root.document.querySelector('script[src*="cover-bind.js"]')) return;
    var script = root.document.createElement('script');
    script.src = 'lib/cover-bind.js?v=20260905c2';
    (root.document.head || root.document.documentElement).appendChild(script);
  } catch (err) {}
})(typeof window !== 'undefined' ? window : this);

(function loadCancelOverview(root) {
  if (!root || !root.document) return;
  try {
    if (root.document.querySelector('script[src*="upload-cancel-overview.js"]')) return;
    var script = root.document.createElement('script');
    script.src = 'lib/upload-cancel-overview.js?v=20260905c3';
    (root.document.head || root.document.documentElement).appendChild(script);
  } catch (err) {}
})(typeof window !== 'undefined' ? window : this);
