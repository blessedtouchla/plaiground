...
function run() {
  ...
  assert.ok(upload.includes('lib/upload-stage.js?v=20260912s2'), 'Upload cache-busts the stage helper');
  assert.ok(upload.includes('site.css?v=20260912s2'), 'Upload cache-busts site.css for the stage paint');
