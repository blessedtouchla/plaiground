...
function run() {
  ...
  assert.ok(upload.includes('lib/upload-stage.js?v=20260912s4'), 'Upload cache-busts the stage helper');
  assert.ok(upload.includes('site.css?v=20260912s4'), 'Upload cache-busts site.css for the stage paint');
  ...
  assert.ok(upload.includes('Drop WAV, FLAC, or MP3 here'), 'dotted audio drop stays under the stage');
