...
function run() {
  ...
  assert.ok(upload.includes('site.css?v=20260912ly8'), 'Upload cache-busts site.css for the type/copy paint');
  ...
  assert.ok(!/Space Grotesk|space-grotesk/i.test(upload), 'Space Grotesk stays on the #275 header');
