...
function run() {
  ...
  assert.ok(upload.includes('lib/upload-stage.js?v=20260912s7'), 'Upload cache-busts the stage helper');
  assert.ok(upload.includes('site.css?v=20260912cr1'), 'Upload cache-busts site.css at the Credits Tesla-cut stamp');
