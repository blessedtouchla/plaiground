...
function run() {
  ...
  APP_PAGES.forEach(function (file) {
    ...
    assert.ok(/<p class="side-label">Act<\/p>/.test(sideNav[0]), file + ' has Act');
    assert.ok(/href="ar\.html">A&amp;R<\/a>/.test(sideNav[0]) && /href="epk\.html">EPK<\/a>/.test(sideNav[0]) && /href="profile\.html">Persona<\/a>/.test(sideNav[0]), file + ' Act links A&R, EPK, and Persona');
    assert.ok(/class="side-price">\$2\.49 a song<\/p>/.test(sideNav[0]), file + ' Create shows the $2.49 add-on');
