...
async function run() {
  ...
  const files = ['lib/mail.js', 'lib/growth-mail.js', 'api/auth.js', 'api/me.js', 'problem.js', 'problem.html', 'signup.html', 'confirm.html', 'confirmed.html', 'login.html', 'forgot.html', 'magic.html', 'README.md', '.env.example'];
  files.forEach((rel) => {
