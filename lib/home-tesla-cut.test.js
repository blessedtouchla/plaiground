...
const CSS_STAMP = '20260918n2';
const JS_STAMP = '20260918n2';
const NAV_STAMP = '20260917pl2';
const ARTISTS_STAMP = '20260922ar2';
...
function run() {
  ...
  assert.ok(/Twenty-nine posts/.test(blog) && blog.includes('blog-no-fakes.html'), 'blog Twenty-nine is not reverted');
