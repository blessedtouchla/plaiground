...
async function run() {
  ...
  assert.ok(tonegrid.storeForwardTimeoutMs(true, Date.now() - 30000) < tonegrid.STORE_FORWARD_TIMEOUT_MS);
  assert.ok(tonegrid.storeForwardTimeoutMs(true, Date.now() - 30000) >= 8000);
