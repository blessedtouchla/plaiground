...
function run() {
  ...
  [splits, how].forEach(function (html) {
    assert.ok(html.includes('site.css?v=' + FLOW_STAMP), 'flow/public page cache-busts site.css at ' + FLOW_STAMP);
  ...
  assert.ok(index.includes('site.css?v=20260918h1'), 'homepage Tesla energy cache-busts site.css at 20260918h1');
  ...
  [dashboard, releases, settings, boosts, howIn, faq, problem].forEach(function (html) {
