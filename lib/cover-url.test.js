...
function run() {
  ...
  assert.ok(coverUrl.isObjectKey('covers/11111111-1111-4111-8111-111111111111/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa-cover.jpg'));
  assert.ok(!coverUrl.isObjectKey('https://cdn.example/cover.jpg'));
  assert.strictEqual(
    coverUrl.objectKey({ artwork_object_key: 'covers/11111111-1111-4111-8111-111111111111/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa-cover.jpg' }),
    'covers/11111111-1111-4111-8111-111111111111/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa-cover.jpg'
  );
