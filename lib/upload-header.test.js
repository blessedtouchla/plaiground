...
function run() {
  ...
  const teslaCss = teslaCutStart === -1 ? '' : css.slice(teslaCutStart, sleeveQuietStart === -1 ? css.length : sleeveQuietStart);
  ...
  assert.ok(upload.includes('site.css?v=20260912tc2'), 'Tesla cut cache-busts site.css at 20260912tc2');
  ...
  assert.ok(upload.includes('lib/upload-audio-bind.js?v=20260912ly6'), 'audio-bind stamp from #274 stays');
