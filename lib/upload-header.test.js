...
function run() {
  ...
  assert.ok(upload.includes('site.css?v=20260912cr2'), 'Credits Tesla cut cache-busts site.css at 20260912cr2');
  ...
  assert.ok(upload.includes('lib/upload-stage.js?v=20260913a1'), 'Release-stage helper stamp follows the iOS Files picker leftover');
  assert.ok(!upload.includes('lib/upload-stage.js?v=20260912s7'), 's7 stamp is retired after the iOS Files picker leftover');
  assert.ok(upload.includes('lib/upload-audio-bind.js?v=20260913a1'), 'audio-bind stamp follows the iOS Files picker leftover');
  assert.ok(!upload.includes('lib/upload-audio-bind.js?v=20260912tc3'), 'tc3 audio-bind stamp is retired');
  assert.ok(upload.includes('lib/audio-accept.js?v=20260913a1'), 'audio-accept stamp follows the iOS Files picker leftover');
  assert.ok(!upload.includes('lib/audio-accept.js?v=20260912tc3'), 'tc3 audio-accept stamp is retired');
  assert.ok(upload.includes('store-client.js?v=20260917ar1'), 'store-client stamp follows the Artist Profiles pick leftover');
  assert.ok(upload.includes('lib/artist-roster.js?v=20260915r2'), 'Upload loads the shared Your Artists roster helper');
  assert.ok(!upload.includes('store-client.js?v=20260913a1'), '20260913a1 store-client stamp is retired');
  assert.ok(!upload.includes('store-client.js?v=20260912cr2'), 'cr2 store-client stamp is retired');
  ...
  assert.ok(!/accept="[^"]*audio\//.test(audioTag), 'Add audio accept has no audio MIME (iOS Take Video)');
