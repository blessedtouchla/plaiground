...
async function run() {
  ...
  assert.ok(reviewHtml.includes('store-client.js?v=20260912a1'), 'review.html cache-busts store-client.js at 20260912a1');
  assert.ok(reviewHtml.includes('lib/store-pick.js?v=20260912a1'), 'review.html cache-busts store-pick.js at 20260912a1');
  ...
  assert.ok(uploadHtmlForBust.includes('store-client.js?v=20260912a1'), 'upload.html cache-busts store-client.js at 20260912a1');
  assert.ok(uploadHtmlForBust.includes('lib/store-pick.js?v=20260912a1'), 'upload.html cache-busts store-pick.js at 20260912a1');
  assert.ok(attestHtml.includes('store-client.js?v=20260912a1'), 'attest.html cache-busts store-client.js at 20260912a1');
  ...
  assert.ok(splitSheetHtml.includes('store-client.js?v=20260912a1'), 'split-sheet.html cache-busts store-client.js at 20260912a1');
