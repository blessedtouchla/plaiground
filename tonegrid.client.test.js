...
async function run() {
  ...
  assert.ok(!uploadHtmlForBust.includes('site.css?v=20260912tc2'), 'upload.html must cache-bust past 20260912tc2');
  ...
  assert.ok(uploadHtmlForBust.includes('site.css?v=20260912ba4'), 'upload.html cache-busts site.css at 20260912ba4');
