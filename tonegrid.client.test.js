...
async function run() {
  ...
  assert.ok(!uploadHtmlForBust.includes('site.css?v=20260912ly6'), 'upload.html must cache-bust past 20260912ly6');
  assert.ok(uploadHtmlForBust.includes('site.css?v=20260912ly7'), 'upload.html cache-busts site.css at 20260912ly7');
